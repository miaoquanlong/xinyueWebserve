<template>
  <div class="tags-view-container">
    ...
    <ul v-show="visible" :style="{left:left+'px',top:top+'px'}" class="contextmenu">
      <li @click="refreshSelectedTag(selectedTag)">11111</li>
      <li @click="closeSelectedTag(selectedTag)">2222222</li>
      <li @click="closeOthersTags">333333</li>
      <li @click="closeAllTags">444444</li>
    </ul>
  </div>
</template>
